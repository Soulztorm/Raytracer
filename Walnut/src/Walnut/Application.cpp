...
namespace Walnut {
	...
	void Application::Init()
	{
		...
		int window_pos_x = (window_width - m_Specification.Width) / 2;
		int window_pos_y = (window_height - m_Specification.Height) / 2;

		glfwSetWindowPos(m_WindowHandle, window_pos_x, window_pos_y);
